...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "СохранениеСценарияGit" Тогда
		Если Параметр.UID = UIDСценария Тогда
...
Процедура СтатусТестов(Команда)
	...
	ДанныеОтбор.Вставить("Тест",ТестыПоUIDНастроек(UIDНастроекТестирования, Проект));
