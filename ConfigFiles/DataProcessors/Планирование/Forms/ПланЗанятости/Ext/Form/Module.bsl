...
Процедура СвернутьСтрокиПодбораСотрудники(Команда)
	...
	Для Каждого РодительскаяСтрока Из ПодборПодразделенияСотрудники.ПолучитьЭлементы() Цикл
		...
		Элементы.ПодборПодразделенияСотрудники.Свернуть(РодительскаяСтрока.ПолучитьИдентификатор());
...
Процедура РазвернутьСтрокиПодбораСотрудники(Команда)
	...
	Для Каждого РодительскаяСтрока Из ПодборПодразделенияСотрудники.ПолучитьЭлементы() Цикл
		...
		Элементы.ПодборПодразделенияСотрудники.Развернуть(РодительскаяСтрока.ПолучитьИдентификатор());
...
Процедура ПоказатьЗначениеСтрокиПодбораСотрудников(Команда)
	...
	ТекущиеДанные = Элементы.ПодборПодразделенияСотрудники.ТекущиеДанные;
...
Процедура ЗаполнитьДанныеВидаПлана(ПараметрыИзмененияВидаПлана)
	...
	ЗаполнитьПодборУчастниковДляОтображенияОтТехПроектов();
...
&НаСервере
Процедура ЗаполнитьПодборУчастниковДляОтображенияОтТехПроектов()
	...
	ПараметрыЗаполнения.СписокУчастников  = УчастникиВидаПлана;
