...
Функция СлужебныеДанныеСценариев(Параметры) Экспорт
	...
	Для Каждого ДанныеСценария Из Данные Цикл
		...
		Если ДанныеСценария.Свойство("НастройкиСценария") И ТипЗнч(ДанныеСценария.НастройкиСценария) = Тип("Массив") Тогда
			ДанныеСценария.Вставить("НастройкиСценария", ДанныеСценария.НастройкиСценария);
		КонецЕсли;	
	...
	СлужебныеДанныеСценариев.Вставить("АдресКешДанныеКоммита", АдресКешДанныеКоммита);
